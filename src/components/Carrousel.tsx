        ...
        <div className="overflow-hidden relative w-full max-w-lg mx-auto">
            ...
            >
                {slides.map((slide, index) => (
                    <Link href="" className="w-full flex-shrink-0 bg-slate-600 rounded-lg" key={index} >
                        <img src={slide.image} alt={`Slide ${index + 1}`} className="w-full h-full object-cover rounded-md" />
                    </Link>
                ))}
            </div>
